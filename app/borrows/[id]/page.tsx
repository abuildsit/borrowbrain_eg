...
export default function BorrowDetailPage({ params }: { params: { id: string } }) {
  ...
  const handleReturnItem = async (returnData: ReturnData) => {
    ...
    console.log("Returning borrow with data:", returnData)
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="flex space-x-2">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link href={`/borrows/${params.id}/edit`}>
              ...
              <Card>
                <CardHeader>
                  <CardTitle className="flex items-center space-x-2">
                    ...
                    <span>Borrow Marked as Gone</span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div>
